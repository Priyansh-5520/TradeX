...
function LandingPage() {
  return <main className="landing relative min-h-screen overflow-hidden bg-background">
    ...
    <nav className="relative z-20 mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8"><TradeXLogo /><div className="hidden items-center gap-8 text-sm text-muted-foreground sm:flex"><span>Markets</span><span>Paper trading</span><span>Analytics</span></div></nav>
